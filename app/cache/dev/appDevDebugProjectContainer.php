...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return new \Waldo\DatatableBundle\Util\Factory\Query\DoctrineBuilder($this->get('doctrine.orm.default_entity_manager'), $this->get('request_stack'));
    }
    ...
    {
        return new \Waldo\DatatableBundle\Util\Formatter\Renderer($this->get('templating'));
    }
    ...
    {
        return $this->services['datatable.twig.extension'] = new \Waldo\DatatableBundle\Twig\Extension\DatatableExtension($this->get('translator'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.terminate', array(0 => 'datatable.kernel.listener.terminate', 1 => 'onKernelTerminate'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'data-base-test', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8ac93f6eb8f79d33dc9ae33889c96c0fe0832c3b6d86de06b992ff496bdabe4d');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[2].'/Resources/WaldoDatatableBundle/views'), 'WaldoDatatable');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58a9fc279a2ab7.28614125')), true);
